...
import { GraduationCap, Building2, ArrowRight, Mail, Lock, User, CircleAlert as AlertCircle, ShieldCheck, CircleCheck as CheckCircle2 } from 'lucide-react'
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 grid lg:grid-cols-2">
        ...
        <div className="relative hidden lg:flex flex-col justify-between bg-ink-900 text-white p-12 overflow-hidden">
          <div className="absolute -top-24 -left-24 h-80 w-80 rounded-full bg-accent-500/20 blur-3xl" />
          <div className="absolute bottom-0 -right-20 h-72 w-72 rounded-full bg-brand-500/15 blur-3xl" />
          <div className="relative">
            <h2 className="font-display text-3xl font-bold">Rejoignez Stagelink</h2>
            <p className="mt-3 text-ink-400 max-w-sm">Inscrivez-vous gratuitement et accédez à des milliers d'offres de stage vérifiées.</p>
          </div>
          <div className="relative space-y-4">
            <div className="flex items-center gap-3 text-sm text-ink-300"><div className="grid h-9 w-9 place-items-center rounded-lg bg-white/10"><CheckCircle2 className="h-4 w-4 text-accent-400" /></div> Inscription en moins d'une minute</div>
            <div className="flex items-center gap-3 text-sm text-ink-300"><div className="grid h-9 w-9 place-items-center rounded-lg bg-white/10"><GraduationCap className="h-4 w-4 text-brand-400" /></div> Profils étudiants et entreprises</div>
            <div className="flex items-center gap-3 text-sm text-ink-300"><div className="grid h-9 w-9 place-items-center rounded-lg bg-white/10"><ShieldCheck className="h-4 w-4 text-accent-400" /></div> Plateforme sécurisée</div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center p-6 sm:p-12 bg-white">
          <div className="w-full max-w-md">
            ...
            <p className="mt-6 text-center text-sm text-ink-500">
              Déjà un compte ?{' '}
              <Link to="/signin" className="font-semibold text-brand-600 hover:text-brand-700">Connexion</Link>
            </p>
          </div>
        </div>
      </div>
